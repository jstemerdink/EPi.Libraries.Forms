...
<div>
    ...
    <div class="Form__Status">
        <span class="Form__Status__Message <%: statusDisplay %>">
    ...
    <div class="Form__MainBody">
        ...
        <nav role="navigation" class="Form__NavigationBar">
            <button type="submit" name="submit" value="<%: SubmitButtonType.PreviousStep.ToString() %>" class="Form__NavigationBar__Action FormExcludeDataRebind btnPrev" <%: prevButtonDisableState %>><%: Html.Translate("/episerver/forms/viewmode/stepnavigation/previous")%></button>
